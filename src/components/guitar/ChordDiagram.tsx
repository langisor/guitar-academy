...
import { ChordData, getChordByName, chordList } from "@/data/guitar/chords"
 ...
 return (
  <div className={cn("flex flex-col items-center", className)}>
   ...
   <div
    ...
    role="img"
    aria-label={`Chord diagram for ${chordData?.name || chordName || "unknown chord"}, ${leftHandMode ? "left-handed" : "right-handed"
     } view`}
   >
    {startFret > 1 && (
